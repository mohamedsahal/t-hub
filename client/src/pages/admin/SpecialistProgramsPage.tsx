...
export default function SpecialistProgramsPage() {
  ...
  const courses = allCourses
    ? allCourses
        .filter((course: Course) => course.type === 'specialist')
  ...
  const editCourse = (courseId: number) => {
    setLocation(`/admin/courses/specialist/edit/${courseId}`);
  };
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage package-based courses with lifetime access to multiple modules
            </p>
          </div>
                ...
                <TableBody>
                  {courses.map((course: Course) => (
                    <TableRow key={course.id}>
                      ...
                      <TableCell>
                        {course.packageSize ? `${course.packageSize} courses` : 'N/A'}
                      </TableCell>
